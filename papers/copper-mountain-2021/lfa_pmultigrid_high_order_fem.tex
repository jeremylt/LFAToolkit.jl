...
In Figure \ref{fig:chebyshev_smooth_factor} we plot the LFA predicted smoothing factor for Chebyshev smoothing as a function of the smoothing parameter $\omega$.
...
This derivation of LFA for p-multigrid allows independently setting these parameters; however we omit this in teh notation for simplicity.
...
\begin{figure}[!tbp]
  \centering
    \subfloat[Convergence for $p = 4$ to $p = 1$, $\nu = 2$]{\includegraphics[width=0.48\textwidth]{img/multi_grid_converge_5_to_2_2smooth}\label{fig:multi_grid_5_2_2smooth}}
    \subfloat[Convergence for $p = 8$ to $p = 1$, $\nu = 2$]{\includegraphics[width=0.48\textwidth]{img/multi_grid_converge_9_to_2_2smooth}\label{fig:multi_grid_9_2_2smooth}}
...
\begin{figure}[!tbp]
  \centering
    \subfloat[Spectral radius for $p = 8$ to $p = 1$, $\nu = 3$]{\includegraphics[width=0.48\textwidth]{img/multi_grid_spectral_radius_9_to_2_2d}\label{fig:multi_grid_spectral_radius_9_2_2d}}
    \subfloat[Convergence for $p = 8$ to $p = 1$, $\nu = 3$]{\includegraphics[width=0.48\textwidth]{img/multi_grid_converge_9_to_2_3smooth_2d}\label{fig:multi_grid_9_2_3smooth_2d}}
