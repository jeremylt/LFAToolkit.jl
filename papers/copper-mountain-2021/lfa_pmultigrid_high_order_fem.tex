...
First order Chebyshev is equivalent to Chebyshev smoothing with $\omega = 1.0$, so the poor smoothing factor is consistent with \cref{fig:jacobi_smooth_factor}.
