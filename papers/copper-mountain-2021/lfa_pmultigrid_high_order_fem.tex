...
$\mathbf{E}_k = \left(\left( \diag {\mathbf{A}} \right)^{-1} {\mathbf{A}} \mathbf{E}_{k - 2} - \alpha \mathbf{E}_{k - 1} - \beta_{k - 2} \mathbf{E}_{k - 2} \right) / \gamma_{k - 1}$
\end{tabular}
...
$\tilde{\mathbf{E}}_k \left( \boldsymbol{\theta} \right) = \left( \tilde{\mathbf{A}}_J \tilde{\mathbf{A}} \left( \boldsymbol{\theta} \right) \tilde{\mathbf{E}}_{k - 2} \left( \boldsymbol{\theta} \right) - \alpha \tilde{\mathbf{E}}_{k - 1} \left( \boldsymbol{\theta} \right) - \beta_{k - 2} \tilde{\mathbf{E}}_{k - 2} \left( \boldsymbol{\theta} \right) \right) / \gamma_{k - 1}$
\end{tabular}
\end{equation}
...
\begin{tabular}{l c c c c}
  ...
  %\cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
  \toprule
  $p = 2$ to $p = 1$   &  0.284  &  0.088  &  0.059  &  0.046  \\
  \midrule
  $p = 4$ to $p = 2$   &  0.337  &  0.126  &  0.058  &  0.051  \\
  $p = 4$ to $p = 1$   &  0.755  &  0.570  &  0.431  &  0.325  \\
  \midrule
  $p = 8$ to $p = 4$   &  0.424  &  0.184  &  0.083  &  0.046  \\
  $p = 8$ to $p = 2$   &  0.795  &  0.633  &  0.505  &  0.403  \\
  $p = 8$ to $p = 1$   &  0.934  &  0.872  &  0.814  &  0.760  \\
  \midrule
  $p = 16$ to $p = 8$  &  0.487  &  0.239  &  0.118  &  0.059  \\
  $p = 16$ to $p = 4$  &  0.837  &  0.701  &  0.587  &  0.491  \\
  $p = 16$ to $p = 2$  &  0.949  &  0.900  &  0.853  &  0.810  \\
  $p = 16$ to $p = 1$  &  0.984  &  0.967  &  0.951  &  0.936  \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{l c c c c}
  ...
  %\cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
  \toprule
  $p = 2$ to $p = 1$   &  0.419  &  0.175  &  0.090  &  0.072  \\
  \midrule
  $p = 4$ to $p = 2$   &  0.581  &  0.338  &  0.196  &  0.114  \\
  $p = 4$ to $p = 1$   &  0.869  &  0.754  &  0.655  &  0.569  \\
  \midrule
  $p = 8$ to $p = 4$   &  0.793  &  0.629  &  0.499  &  0.397  \\
  $p = 8$ to $p = 2$   &  0.924  &  0.854  &  0.789  &  0.729  \\
  $p = 8$ to $p = 1$   &  0.976  &  0.952  &  0.929  &  0.907  \\
  \midrule
  $p = 16$ to $p = 8$  &  0.919  &  0.844  &  0.776  &  0.714  \\
  $p = 16$ to $p = 4$  &  0.966  &  0.932  &  0.900  &  0.869  \\
  $p = 16$ to $p = 2$  &  0.987  &  0.973  &  0.960  &  0.947  \\
  $p = 16$ to $p = 1$  &  0.995  &  0.991  &  0.986  &  0.982  \\
  \bottomrule
\end{tabular}
\end{center}
