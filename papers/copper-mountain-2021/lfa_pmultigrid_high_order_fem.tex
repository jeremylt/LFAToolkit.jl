...
Our numerical experiments were conducted using the libCEED with PETSc \cite{petsc-user-ref} multigrid example found in the libCEED repository.
...
\end{tabular}
\end{center}
\caption{LFA and Experimental two-grid convergence factor with Jacobi smoothing for 3D Laplacian}
