...
The results in \cref{table:two_grid_1d_chebyshev} provide the two grid convergence factor and optimal values of $k$ for two-grid high-order p-multigrid for a variety of coarsening rates and orders of Chebyshev smoother.
